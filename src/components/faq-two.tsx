            ...
            <div className="xl:col-span-6 lg:col-span-7 col-span-12">
                <div className="relative">
                    <div className="relative md:shrink-0 lg:mx-0 mx-5">
                        <img className="object-cover lg:w-96 sm:w-[80%] w-[80%] sm:h-[500px] h-[450px] rounded-lg shadow-md dark:shadow-gyay-700" src={image1} alt=""/>
                    </div>

                    <div className="absolute bottom-10 lg:end-6 end-0">
                        <div className="absolute z-1 -top-[26px] left-0 xl:text-end lg:text-start text-start">
