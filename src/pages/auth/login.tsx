                    ...
                    <div className="max-w-[400px] w-full p-6 bg-white dark:bg-slate-900 rounded-md">
                        ...
                        <form className="text-start">
                            <div className="grid grid-cols-1">
                                ...
                                <div className="mb-4">
                                    <Link to="#" className="h-10 px-5 tracking-wide inline-flex items-center justify-center font-medium rounded-md bg-primary text-white w-full">Login / Sign in</Link>
                                </div>

                                <div className="text-center">
                                    <span className="text-slate-400 me-2">Don't have an account ?</span> <Link to="/signup" className="text-slate-900 dark:text-white font-bold">Sign Up</Link>
                                </div>
                            </div>
                        </form>
                    </div>
